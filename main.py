...
class patient_update(BaseModel):
    ...
    id:Annotated[Optional[str],Field(..., description='ID of patient', examples=['P001'])]
    ...
    height:Annotated[Optional[int],Field(... , gt=0)]
    weight:Annotated[Optional[int],Field(...,gt=0)]
...
def update(patient_id :str , patient_update:patient_update):
    ...
    patient_pydantic_obj = Patients(**existing_data)
